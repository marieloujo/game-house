...
@section('title') Games House - Accueil @endsection
            ...
            <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;"
                ...
                <ul>
                    <li data-index="rs-3045" data-transition="zoomout" data-slotamount="default"
                        ...
                        data-thumb="{{ asset('assets/images/banner-1-100x50.jpg') }}" data-rotate="0" data-fstransition="fade"
                        data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                        data-title="Intro" data-param1 data-param2 data-param3 data-param4 data-param5 data-param6
                        data-param7 data-param8 data-param9 data-param10 data-description>

                        <img src="{{ asset('assets/images/banner-1.jpg') }}" alt="img" data-bgposition="center center" data-bgfit="cover"
                            data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>


                        <div class="tp-caption NotGeneric-Title tp-resizeme d-none d-lg-block d-md-block" id="slide-3045-layer-1"
                            ...
                            data-paddingleft="[0,0,0,0]" style="z-index: 5; white-space: nowrap;">
                            Bienvenue sur Game Houses
                        </div>

                        <div class="tp-caption NotGeneric-Title tp-resizeme d-block d-md-none d-lg-none" id="slide-3045-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                    ...
                    <li data-index="rs-3046" data-transition="fadetotopfadefrombottom" data-slotamount="default"
                        ...
                        data-thumb="{{ asset('assets/images/banner-2-100x50.jpg') }}" data-rotate="0" data-saveperformance="off"
                        data-title="Explorez vos désirs passionnés" data-param1 data-param2 data-param3 data-param4 data-param5
                        data-param6 data-param7 data-param8 data-param9 data-param10 data-description>

                        <img src="{{ asset('assets/images/banner-2.jpg') }}" alt="img" data-bgposition="center center" data-bgfit="cover"
                            data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>

                        <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-3 d-none d-md-block d-lg-block"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[10,10,10,10]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[10,10,10,10]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 8; white-space: nowrap;">
                            Explorez vos désirs passionnés
                        </div>

                        <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-3 d-block d-lg-none d-md-none"
                            id="slide-3046-layer-1" data-x="['center','center','center','center']"
                            data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-2"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 9; white-space: nowrap;">
                            Plaisir, Découverte, Intimité
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-8" id="slide-3046-layer-10"
                            ...
                            <div class="rs-looped rs-pendulum" data-easing="linearEaseNone" data-startdeg="-20"
                                data-enddeg="360" data-speed="35" data-origin="50% 50%"><img
                                    src="{{ asset('assets/images/blurflake4.png') }}" alt="img"
                        ...
                        <div class="tp-caption tp-resizeme rs-parallaxlevel-7" id="slide-3046-layer-11"
                            ...
                            <div class="rs-looped rs-wave" data-speed="20" data-angle="0" data-radius="50px"
                                data-origin="50% 50%"><img src="{{ asset('assets/images/blurflake3.png') }}" alt="img"
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-4" id="slide-3046-layer-12"
                            ...
                            <div class="rs-looped rs-rotate" data-easing="Power2.easeInOut" data-startdeg="-20"
                                data-enddeg="360" data-speed="20" data-origin="50% 50%"><img
                                    src="{{ asset('assets/images/blurflake2.png') }}" alt="img" data-ww="['50px','50px','50px','50px']"
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-6" id="slide-3046-layer-13"
                            ...
                            <div class="rs-looped rs-wave" data-speed="4" data-angle="0" data-radius="10"
                                data-origin="50% 50%"><img src="{{ asset('assets/images/blurflake1.png') }}" alt="img"
                    ...
                    <li data-index="rs-3047" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
                        ...
                        data-masterspeed="2000" data-thumb="{{ asset('assets/images/banner-3-100x50.jpg') }}" data-rotate="0"
                        data-saveperformance="off" data-title="Create Profile" data-param1 data-param2 data-param3
                        data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10
                        data-description>

                        <img src="{{ asset('assets/images/banner-3.jpg') }}" alt="img" data-bgposition="center center" data-kenburns="on"
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper   tp-resizeme" id="slide-3047-layer-9"
                            ...
                            data-width="1000" data-height="140" data-whitespace="nowrap" data-type="shape"
                            data-responsive_offset="on"
                        ...
                        <div class="tp-caption NotGeneric-Title tp-resizeme d-none d-md-block d-lg-block" id="slide-3047-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-fontsize="['70','70','70','45']" data-lineheight="['70','70','70','50']"
                            data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[10,10,10,10]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[10,10,10,10]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 16; white-space: nowrap;">
                            Trouvez ce que vous cherchez
                        </div>

                        <div class="tp-caption NotGeneric-Title tp-resizeme d-block d-md-none d-lg-none" id="slide-3047-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-fontsize="['70','70','70','35']" data-lineheight="['70','70','70','50']"
                            data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme" id="slide-3047-layer-4"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 17; white-space: nowrap;">
                            Compatibilité, Flexibilité, Choix
                        </div>
                    </li>

                    <li data-index="rs-3049" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
                        data-hideslideonmobile="off" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
                        data-masterspeed="2000" data-thumb="{{ asset('assets/images/banner-4-100x50.jpg') }}" data-rotate="0"
                        data-saveperformance="off" data-title="Start Dating" data-param1 data-param2 data-param3
                        data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10
                        data-description>

                        <img src="{{ asset('assets/images/banner-4.jpg') }}" alt="img" data-bgposition="center center" data-kenburns="on"
                        ...
                        <div class="tp-caption NotGeneric-Title tp-resizeme d-none d-md-block d-lg-block" id="slide-3049-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-fontsize="['70','70','70','45']" data-lineheight="['70','70','70','50']"
                            data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[10,10,10,10]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[10,10,10,10]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 22; white-space: nowrap;">
                            Construisez votre profil unique
                        </div>

                        <div class="tp-caption NotGeneric-Title tp-resizeme d-block d-md-none d-lg-none" id="slide-3049-layer-1"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                            data-fontsize="['70','70','70','35']" data-lineheight="['70','70','70','50']"
                            data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme" id="slide-3049-layer-4"
                            ...
                            data-textalign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                            data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]" style="z-index: 23; white-space: nowrap;">
                            Un profil attrayant qui met en valeur votre personnalité
                        </div>
...
<!-- BEGIN APROPOS -->
<div id="a-propos-de-nous" class="dating-wapper w-100 float-start">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-lg-6 col-md-12 col-12 order-lg-1">
                <div class="dating-content">
                    <div class="heading">
                        <h2>Amour <strong>véritable</strong> ou Epanouissement <strong>passionné</strong> </h2>
                        <div class="heart-line">
                            <i class="fas fa-heart"></i>
                        </div>
                    </div>
                    <p class="text-justify">
                        Découvrez notre plateforme où vous pouvez trouver
                        l'amour authentique ou l'épanouissement passionné,
                        selon vos désirs et aspirations.
                        <br/>
                        <br/>
                        Que vous recherchiez une relation durable basée sur la compatibilité et la sincérité,
                        ou que vous souhaitiez explorer des rencontres passionnées et intimes,
                        Nous sommes là pour répondre à vos besoins.
                        Notre site vous offre un espace sécurisé et bienveillant
                        pour rencontrer des personnes partageant vos intérêts et vos valeurs.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-12 order-lg-12">
                <img src="{{ asset('assets/images/dating-img.png') }}" alt="dating-img" class="img-fluid">
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="change-box w-100 float-start">
                        ...
                        <div class="custum-select">
                            <select class>
                                <option value data-display-text="Une relation authentique">
                                    Une relation authentique
                                </option>
                                <option value="Des moments passionné">Des moments passionnés</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="change-box change-box-res w-100 float-start">
                        <label class="label-2nd">Ages:</label>
                ...
                <div class="col-lg-2 col-md-12 col-12">
                    <div class="main-btn-2">
                        <a href="searchbar.html" class="main-btn">Rechercher</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="dating-wapper w-100 float-start">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-12 order-lg-1">
                <div class="about-us-img text-start d-none d-lg-block">
                    <img src="{{ asset('assets/images/about-us.jpg') }}" alt="about-us" class="img-fluid">
                    <div class="testimaonl-box">
                        <div class="icon">
                            <i class="fas fa-quote-left"></i>
                        </div>
                        <div class="text">
                            <p>Notre plateforme vous offre une variété d'outils et de fonctionnalités
                                pour trouver des partenaires compatibles avec qui vous pouvez explorer
                                vos fantasmes et vos préférences.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-12 col-12 order-lg-12">
                <div class="dating-content">
                    <div class="heading">
                        <h2>Expérimentez la passion sans compromis</h2>
                        <div class="heart-line">
                            <i class="fas fa-heart"></i>
                        </div>
                    </div>
                    <div class="about-us-img text-start d-block d-lg-none mb-5">
                        ...
                        <div class="testimaonl-box">
                            ...
                            <div class="text">
                                <p style="color: white !important;">
                                    Découvrez une expérience de rencontre épanouissante
                                    où vous explorer vos désirs passionnés sans compromis.
                                    <br/><br/>
                                    Que vous soyez à la recherche de rencontres sensuelles,
                                    de relations intimes ou d'aventures passionnées,
                                    notre plateforme vous offre un espace pour vivre pleinement votre sexualité.
                                </p>
                            </div>
                        </div>
                    </div>
                    <p class=" d-none d-lg-block">
                        Explorez vos désirs passionnés avec des partenaires qui comprennent et partagent vos envies.
                        Nous encourageons l'ouverture, l'acceptation et la liberté d'explorer votre sexualité
                        en toute confiance.
                        Découvrez des rencontres passionnées et épanouissantes qui éveilleront vos sens.
                        <br>
                        <br>
                        Nous comprenons que chacun a des besoins et des préférences uniques.
                            C'est pourquoi nous vous permettons de définir vos propres critères
                            et de rechercher des partenaires qui partagent vos passions et vos intérêts.
                            Que vous souhaitiez explorer des fantasmes, partager des expériences sensuelles
                            ou simplement trouver des partenaires ouverts d'esprit,
                            vous trouverez des personnes prêtes à vivre des moments de passion avec vous.
                        <br>
                        <br>
                        Rejoignez notre communauté et plongez dans un monde de possibilités sensuelles
                        et de rencontres passionnantes. Découvrez une nouvelle dimension de la connexion
                        humaine où la passion est célébrée et exprimée sans limites. Osez expérimenter,
                        vivre pleinement et éveiller vos sens avec
                    </p>
                    <ul class="btn-ul justify-content-center justify-content-lg-start">
                        <li>
                            <a href="{{ route('register') }}" class="main-btn main-btn-iocn">
                                <span class="icon">
...
<div class="how-it-work how-it-work-3 how-it-work-next bg-color2 w-100 float-start">
    <div class="container">
        <div class="heading center-heading">
            <h2>Comment <strong>ça</strong> marche</h2>
            <div class="heart-line">
                <i class="fas fa-heart"></i>
            </div>
            <p>
                Découvrez comment notre plateforme fonctionne pour vous aider
                à trouver des connexions authentiques des relations durables et des expériences passionnées.
            </p>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="counter-box-2">
                        <div class="counter-icon">
                            <img src="{{ asset('assets/images/ind3-add-icon.png') }}" alt="work-img">
                        </div>
                        <div class="counter-text-2">
                            <h5>Inscrivez-vous</h5>
                            <span>créer un profil détaillé qui reflète votre personnalité,
                                vos intérêts et vos préférences</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="counter-box-2">
                        <div class="counter-icon">
                            <img src="{{ asset('assets/images/ind3-date-icon.png') }}" alt="work-img">
                        </div>
                        <div class="counter-text-2">
                            <h5>Trouver la bonne personne</h5>
                            <span>Parcourez les profils des autres membres en utilisant
                                nos filtres de recherche avancés</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="counter-box-2">
                        <div class="counter-icon">
                            <img src="{{ asset('assets/images/ind3-partner-icon.png') }}" alt="work-img">
                        </div>
                        <div class="counter-text-2">
                            <h5>Commencer les rencontres</h5>
                            <span>Organisez une rencontre romantique, un rendez-vous
                                une aventure sensuelle</span>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- BEGIN LOVE CALCULATOR -->
<div class="doctor-love doctor-love-2 w-100 float-start">
    <div class="container">
        <div class="heading center-heading">
            <h2>Déterminez votre alchimie amoureuse !</h2>
            <div class="heart-line">
                <i class="fas fa-heart"></i>
            </div>
            <p>Découvrez la magie de la compatibilité avec notre fonctionnalité exclusive
                qui évalue l'affinité entre vous et votre crush.
                Entrez simplement vos noms et explorez les possibilités de relations durables et passionnantes sur
                <strong>Game Houses</strong>.</p>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="calc-inner-box">
                        <div class="love-inner-box">
                            <div class="enter-name1">
                                <label for="nameInput1">Votre Nom</label>
                                <input type="text" id="nameInput1" placeholder="Nom complet">
                            </div>
                            <div class="enter-name2">
                                <label for="nameInput2">Votre Crush</label>
                                <input type="text" id="nameInput2" placeholder="Nom du crush" />
                            </div>
                            <div class="calculat-love">
                                <button class="main-btn" onclick="magicHappens()">Calculer</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-5 col-xl-7 col-xxl-6">
                    <div class="love-result">
                        <svg class="circle d-none d-lg-block" xmlns="http://www.w3.org/2000/svg" width="620"
                            height="300">
                            <defs>
                            ...
                            <circle class="circle__path" cy="300" cx="310" r="300" stroke="url(#linearColors1)">
                            </circle>
                        </svg>
...
<!-- BEGIN MEMBERS -->
<div class="how-it-work how-it-work-2 bg-color2 w-100 float-start" id="les-menbres">
    <div class="container">
        <div class="heading center-heading">
            <h2>Nos <strong>meilleurs</strong> membres</h2>
            <div class="heart-line">
                <i class="fas fa-heart"></i>
            </div>
            <p>
                Découvrez certains de nos membres les plus populaires. <br/>
                Explorez ces profils pour trouver des personnes qui pourraient
                correspondre à vos attentes et aspirations.
            </p>
        </div>
        <div class="awesome-slider nos-membres-section">
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <a href="{{ route('profil') }}">
                        <div class="members-box">
                            <div class="members-img">
                                <img src="{{ asset('assets/images/members-img1.jpg') }}" alt="members-img1" class="img-fluid">
                            </div>
                ...
                <div class="item">
                    <a href="{{ route('profil') }}">
                        <div class="members-box">
                            <div class="members-img">
                                <img src="{{ asset('assets/images/members-img2.jpg') }}" alt="members-img2" class="img-fluid">
                            </div>
                            <div class="members-text">
                                    <h6>Pari Parmar</h6>
                                <span>landon</span>
                ...
                <div class="item">
                    <div class="members-box">
                        <div class="members-img">
                            <img src="{{ asset('assets/images/members-img3.jpg') }}" alt="members-img3" class="img-fluid">
                        </div>
                        <div class="members-text">
                            <a href="{{ route('profil') }}">
                                <h6>Tulshi Jat</h6>
                ...
                <div class="item">
                    <div class="members-box">
                        <div class="members-img">
                            <img src="{{ asset('assets/images/members-img4.jpg') }}" alt="members-img4" class="img-fluid">
                        </div>
                        <div class="members-text">
                            <a href="{{ route('profil') }}">
                                <h6>Vijay Chouhan</h6>
                ...
                <div class="item">
                    <div class="members-box">
                        <div class="members-img">
                            <img src="{{ asset('assets/images/members-img3.jpg') }}" alt="members-img1" class="img-fluid">
                        </div>
                        <div class="members-text">
                            <a href="{{ route('profil') }}">
                                <h6>Sarika Thakur</h6>
                ...
                <div class="item">
                    <a href="{{ route('profil') }}">
                        <div class="members-box">
                            <div class="members-img">
                                <img src="{{ asset('assets/images/members-img4.jpg') }}" alt="members-img3" class="img-fluid">
                            </div>
                            <div class="members-text">
                                    <h6>Tulshi Jat</h6>
                                <span>toto</span>
                ...
                <div class="item">
                    <div class="members-box">
                        <div class="members-img">
                            <img src="{{ asset('assets/images/members-img3.jpg') }}" alt="members-img4" class="img-fluid">
                        </div>
                        <div class="members-text">
                            <a href="{{ route('profil') }}">
                                <h6>Vijay Chouhan</h6>
        ...
        <div class="awesome-btn">
            <a href="{{ route('membres') }}" class="index2-btn2">Voir plus</a>
        </div>
    </div>
</div>
<!-- END MEMBERS -->
...
<div class="how-it-work main-princing-section w-100 float-start" id="nos-tarifs">
    <div class="container">
        <div class="heading center-heading">
            <h2>Nos <strong>formules</strong> d'abonnement</h2>
            <div class="heart-line">
                <i class="fas fa-heart"></i>
            </div>
            <p>
                Nous proposons des offres flexibles qui répondent à vos besoins et à votre budget. <br>
                Découvrez nos options d'abonnement pour profiter pleinement de notre plateforme
                de rencontres exceptionnelle.
            </p>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-12 order-lg-1">
                <div class="app-content text-center text-lg-start mb-5 mb-lg-0">
                    <div class="heading">
                        <h2>Téléchargez <br>
                            <strong>Notre application</strong> mobile
                        </h2>
                    </div>
                    <p>
                        Profitez de l'expérience de rencontre ultime où que vous soyez en téléchargeant notre application.
                        Disponible sur les plateformes iOS et Android, elle vous permet de rester connecté(e)
                        et d'accéder à toutes les fonctionnalités du site où que vous soyez.
                    </p>
                    <ul class="btn-ul justify-content-center justify-content-lg-start">

                        <li>
                            <a href="javacript:;">
                                <img src="{{ asset('assets/images/ind4-google-btn.png') }}" alt="mobile-img">
                            </a>
                        </li>
                        <li>
                            <a href="javascript:">
                                <img src="{{ asset('assets/images/ind4-appstore-btn.png') }}" alt="mobile-img">
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-12 col-12 order-lg-12">
                <div class="mobile-img">
                    <img src="{{ asset('assets/images/app-img.png') }}" alt="app-img" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<!-- BEGIN CONTACT -->
<div id="nous-contacter" class="contact-section w-100 float-start">
    <div class="container">
       <div class="heading center-heading">
          <h2>Prenez <strong>contact</strong> avec nous</h2>
          <div class="heart-line">
             <i class="fas fa-heart"></i>
          </div>
          <p>Nous sommes impatients de vous entendre !
            Prenez contact avec nous dès aujourd'hui et laissez-nous <br>
            vous accompagner dans votre recherche de l'amour authentique,
            de connexions passionnantes et de relations durables.</p>
       </div>
                      ...
                      <div class="col-lg-6 col-md-12 col-12">
                         <div class="contact-detail-box">
                            ...
                            <div class="contact-detail-list">
                               ...
                               <div class="contact-detail-text">
                                  <p>Succursale:</p>
                                  <p>Webstrot Company, 5 Lala laj path rai
                                     marg
                               ...
                               <div class="contact-detail-text">
                                  <p>Email:</p>
                                  <p>
                                     <a href="javascript:;"><span>contact@yourdomain.com</span></a>
                                     <br>
                                     <a href="javascript:;"><span>info@yourdomain.com</span></a>
                                  </p>
                               </div>
                            </div>
                         </div>
                ...
                <div class="form-box">
                   <div class="row">
                      ...
                      <div class="col-lg-7 col-md-12 col-12">
                         <div class="main-form">
                            <h4>Pour toute question, veuillez laisser un message.</h4>
                            <form>
                               <div class="form-input">
                                  <input type="text"
                                     id="validationCustom01"
                                     placeholder="Nom complet *" required>
                                  <label for="validationCustom01"><i
                               ...
                               <div class="form-input">
                                  <input type="email"
                                     ...
                                     required>
                                  <label for="validationCustom02"><i
                               ...
                               <div class="form-input">
                                  ...
                                  <label for="validationCustom03"><i
                                        class="fas fa-share"></i></label>
                               </div>
                               <div class="form-input">
                                  <input type="tel" id="validationCustom04"
                                     placeholder="Télephone" required>
                                  <label for="validationCustom04"><i
                                        class="fas fa-share"></i></label>
                               </div>
                               <div class="form-input">
                                  <textarea id="validationTextarea"
                                     placeholder="Message" required></textarea>
                                  <label for="validationTextarea"><i
                                        class="fas fa-share"></i></label>
                               </div>
                               <div class="form-input">
                                  <button class="main-btn" type="submit">Envoyez</button>
                               </div>
                            </form>
                         </div>
                      </div>
